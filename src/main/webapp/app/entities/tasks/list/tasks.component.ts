...
export class TasksComponent implements OnInit {
  ...
  trackId(_index: number, item: ITasks): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ITasks[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
